...
var (
	...
	resourcesExample = templates.Examples(`
		...
		kubectl-kruise set resources cloneset nginx --limits=cpu=200m,memory=512Mi --requests=cpu=100m,memory=256Mi

		# Remove the resource requests for resources on containers in nginx
		kubectl-kruise set resources deployment nginx --limits=cpu=0,memory=0 --requests=cpu=0,memory=0
		kubectl-kruise set resources cloneset nginx --limits=cpu=0,memory=0 --requests=cpu=0,memory=0
