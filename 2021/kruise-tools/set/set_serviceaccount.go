...
var (
	serviceaccountResources = i18n.T(`replicationcontroller (rc), deployment (deploy), daemonset (ds), job, replicaset (rs), statefulset, cloneset`)
	...
	kubectl-kruise set serviceaccount cloneset nginx-deployment serviceaccount1
